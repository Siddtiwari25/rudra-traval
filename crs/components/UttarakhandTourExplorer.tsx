// src/components/UttarakhandTourExplorer.tsx
...
const TOUR_ADDONS: Record<string, TourAddon[]> = {
  ...
  'tour-kumaon-lakes': [
    ...
    { id: 'birding', name: 'Pangot Himalayan bird tracking', description: 'Walk pine valleys identifying colorful local bird nests.', pricePerPerson: 15 },
